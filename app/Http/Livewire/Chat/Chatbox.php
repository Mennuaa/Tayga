...
class Chatbox extends Component
{
    ...
    public function  getListeners()
    {
        ...
        return [
            ...
            'loadConversation', 'pushMessage', 'getFilm','loadmore', 'updateHeight','broadcastMessageRead','resetComponent'
        ];
    }
...
$this->receiverInstance= null;
    ...
    public function render()
    {
        ...
        $films = Film::all();
        return view('livewire.chat.chatbox', ["requests"=>$requests,"films"=>$films]);
    }
}
